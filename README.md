...
### [`.aliases`](https://github.com/garycocs/dotfiles/blob/master/.aliases) and [`.functions`](https://github.com/garycocs/dotfiles/blob/master/.functions)
...
One-off binaries that aren't via an npm global or homebrew. [git open](https://github.com/garycocs/git-open), [wifi-password](https://github.com/rauchg/wifi-password), [coloredlogcat](https://developer.sinnerschrader-mobile.com/colored-logcat-reloaded/507/), [git-overwritten](https://github.com/mislav/dotfiles/blob/master/bin/git-overwritten), and `subl` for Sublime Text.
